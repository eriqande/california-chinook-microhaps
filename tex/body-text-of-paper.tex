...
($10^{-4}$ or less) in {\bf b}, as indicated by the error bars, which represent the estimate $\pm 2 \times s$ where $s$ is the estimated standard error of the mean of the Monte Carlo sample.  }
\begin{center}
