...
from 17 collections, genotyped at 204 loci, mostly microhaplotypes \citep{baetscher2018microhaplotypes}, from throughout the genome.
This baseline is
...
in Data Supplement~1.  An overview of genomic coordinates is found in Fig.~\ref{fig:genome-locations}
...
between the groups and are included in the reference baseline baseline.  The process of 
