...
We sampled fish for the reference baselines from 8 locations on the across the two
...
%%%%%%%%%%%%%
\begin{figure}
\newcommand{\mapcap}{\footnotesize  A map of sampling locations within
California represented in the reference baseline.  The colored circles aside
