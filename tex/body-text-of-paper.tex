...
to the river. Subsequently n the Fall, when hatchery raceways are reopened, only fish with the visible tag are included
as Spring-run broodstock. Individual-based analysis 
