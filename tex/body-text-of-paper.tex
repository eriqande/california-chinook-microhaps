...
Two broadly applicable innovations that has been
...
A further consideration in the development of a reference baseline for GSI is that
the same panel of loci used for GSI, if properly designed, can also serve as a
markers for parentage based tagging (PBT).  
