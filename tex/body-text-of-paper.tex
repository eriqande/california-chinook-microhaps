...
a strong association between these ecotypes and the alleles carried near the GREB1L and ROCK1 genes
...
We include a novel marker that targets the sex-determining region ({\em sdY}) on the Y chromosome in Chinook salmon. We designed this marker through examination of whole-genome sequence data in multiple populations of California Chinook salmon \citep{thompson2020complex}.
This marker characterizes genetic sex in diverse California salmon populations more accurately than previously published marker assays \citep{von2015development}.
