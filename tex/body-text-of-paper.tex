...
Results from the model-based clustering analysis with the program STRUCTURE, revealed patterns of population relationships that are coincident with previous work (Clemento et al. 2014; Kinziger et al. 2013), emphasizing the distinction between Chinook salmon
...
presence of mixed ancestry in the Coastal California population in the Russian River, which is consistent with its location, at the southernmost edge of the Coastal Chinook salmon between the mouths of the Sacramento River and the other Coastal Chinook salmon basins to the north.