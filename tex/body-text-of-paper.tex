...
rates (FNRs) for distinguishing between different relationships. Groupings for panels that are neither a previously defined reporting unit nor a single collection as follows: TRH = \{TRS, TRF\}; FRH = \{FRHS, FRHF\}; CVF = \{BCF, MDF, SJRF\}.  {\bf (a)} FPRs calculated
